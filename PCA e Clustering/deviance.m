...
%% Read the data
data = xlsread("C:\Users\ogiam\Desktop\Impianti di Elaborazione\Web Server\Workload Characterization\Low Level\Low-Level.xlsx");
pca_data = xlsread("C:\Users\ogiam\Desktop\Impianti di Elaborazione\Web Server\Workload Characterization\Low Level\Low Level PCA.xlsx");
cluster_data = xlsread("C:\Users\ogiam\Desktop\Impianti di Elaborazione\Web Server\Workload Characterization\Low Level\Low Level Cluster.xlsx");
...
tot = (W+B)/DEV_PCA % check if W+B is equal to the deviance after pca
